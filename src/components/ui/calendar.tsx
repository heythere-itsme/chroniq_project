...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-primary-dark rounded-lg p-4 shadow-sm",
        className
      )}
      ...
      classNames={{
        ...
        today: cn("ring-1 ring-offset-2 ring-primary", defaultClassNames.today),
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "w-full aspect-square p-0 leading-none font-normal transition-all",

        // Selected single
        "data-[selected-single=true]:bg-Selected data-[selected-single=true]:rounded-[8px] ",

        // Range
        "data-[range-start=true]:bg-Selected data-[range-end=true]:bg-Selected data-[range-middle=true]:bg-Selected",
        "data-[range-start=true]:text-black data-[range-end=true]:text-black data-[range-middle=true]:text-black",
        "data-[range-start=true]:backdrop-blur-lg data-[range-end=true]:backdrop-blur-lg data-[range-middle=true]:backdrop-blur-lg",
        "data-[range-start=true]:rounded-l-[8px] data-[range-start=true]:rounded-r-none data-[range-end=true]:rounded-r-[8px] data-[range-end=true]:rounded-l-none data-[range-middle=true]:rounded-none",
        ...
        // Hover
        "hover:border-white hover:border-[1px] hover:rounded-[8px]",

        // Focus
        "group-data-[focused=true]/day:ring-[3px] group-data-[focused=true]/day:ring-ring/50 group-data-[focused=true]/day:border-ring",

        // Children span styling
